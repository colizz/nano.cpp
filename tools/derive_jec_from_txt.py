#!/usr/bin/env python3
"""Derive correctionlib JME payloads from legacy JetMET txt tarballs.

This is intentionally narrow: it supports the Run-2 JEC/JER txt formats needed
for AK4PFPuppi subjets and the AK4PFchs validation cross-check.
"""
...
def validate_ak4chs(args: argparse.Namespace) -> None:
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        payload = build_payload(args.jec_tar, args.jec_tag, "AK4PFchs", ["L1FastJet", "L2Relative", "L3Absolute", "L2L3Residual"], None, None)
